...
describe('generateSVG function', () => {
    it('should generate SVG for a circle', () => {
        ...
        expect(result).toContain('<text x="150" y="115" font-size="60" text-anchor="middle" fill="#000000">Circle</text>');
    });
    ...
    it('should generate SVG for a triangle', () => {
        ...
        expect(result).toContain('<text x="150" y="115" font-size="60" text-anchor="middle" fill="#ffffff">Triangle</text>');
    });
    ...
    it('should generate SVG for a square', () => {
        ...
        expect(result).toContain('<text x="150" y="115" font-size="60" text-anchor="middle" fill="#0000ff">Square</text>');
    });
});